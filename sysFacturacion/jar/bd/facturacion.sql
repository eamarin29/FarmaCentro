--------------------------------------------------------
-- Archivo creado  - sábado-julio-08-2017   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "FACTURACION"."PARAMETROS" 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "FACTURACION"."PARAMETROS_PK" ON "FACTURACION"."PARAMETROS" ("NOMBRE_PARAMETRO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "FACTURACION"."PARAMETROS" ADD CONSTRAINT "PARAMETROS_PK" PRIMARY KEY ("NOMBRE_PARAMETRO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "FACTURACION"."PARAMETROS" MODIFY ("NOMBRE_PARAMETRO" NOT NULL ENABLE);
--------------------------------------------------------
