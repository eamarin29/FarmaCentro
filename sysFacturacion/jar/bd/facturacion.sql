--------------------------------------------------------
-- Archivo creado  - domingo-julio-16-2017   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "FACTURACION"."DETALLE_FACTURA" 
   (	"CODDETALLE" NUMBER, 
	...
	"PRECIO_REAL_UNIDAD" NUMBER(10,2), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "FACTURACION"."EMPLEADO" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "FACTURACION"."SERVICIO" 
   (	"CODIGO" NUMBER(*,0), 
	"TOTAL" NUMBER(10,2), 
	"GANANCIA_EMPRESA" NUMBER(10,2), 
	"GANANCIA_EMPLEADO" NUMBER(10,2), 
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "FACTURACION"."FACTURA_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "FACTURACION"."EMPLEADO_PK" ON "FACTURACION"."EMPLEADO" ("CEDULA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "FACTURACION"."SERVICIOS_PK" ON "FACTURACION"."SERVICIO" ("CODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "FACTURACION"."EMPLEADO" ADD CONSTRAINT "EMPLEADO_PK" PRIMARY KEY ("CEDULA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "FACTURACION"."EMPLEADO" MODIFY ("CEDULA" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "FACTURACION"."SERVICIO" ADD CONSTRAINT "SERVICIOS_PK" PRIMARY KEY ("CODIGO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "FACTURACION"."SERVICIO" MODIFY ("CODIGO" NOT NULL ENABLE);
--------------------------------------------------------
